...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_nc', type=int, default=24, help='# of input image channels')
        ...
        parser.add_argument('--loss_GAN', type=float, default=1, help='content loss, perceptual')
        parser.add_argument('--loss_vgg', type=float, default=0.5, help='content loss, perceptual')
        parser.add_argument('--use_vgg', action='store_true', help='show the details of mask generator')
        parser.add_argument('--loss_ssim', type = float, default=0, help='The ratio of SSIM loss')
        parser.add_argument('--imscale', type=int, default=512, help='the size of image, help certify the size of discriminator')
        parser.add_argument('--c_dim', type=int, default=6, help='the number of destination type')
        parser.add_argument('--contrast', type=str, default='t1fse', help = 'the name of target label')
